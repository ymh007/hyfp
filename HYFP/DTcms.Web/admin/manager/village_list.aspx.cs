...
{
    public partial class village_list : Web.UI.ManagePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("village", DTEnums.ActionEnum.View.ToString()); //检查权限
                RptBind();
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", "village_list.aspx");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除数据成功！", "village_list.aspx", "parent.loadMenuTree");
        }
    }
}