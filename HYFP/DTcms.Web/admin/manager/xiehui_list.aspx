<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xiehui_list.aspx.cs" Inherits="DTcms.Web.admin.manager.xiehui_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="xiehui_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      <th width="6%">选择</th>
      <th align="left" width="8%">协会名称</th>
      <th align="left" width="8%">所属乡镇</th>
      <th align="left" width="8%">所属村</th>
      <th align="left" width="8%">负责人</th>
      <th align="left" width="8%">负责人电话</th>
      <th align="left" width="8%">协会地址</th>
      <th align="left" width="8%">协会账号</th>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td>
        ...
        <a href="xiehui_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("name")%></a>
      </td>
      ...
      <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        <a href="xiehui_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
        <a href="xiehui_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
