...
{
    public partial class village_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == DTEnums.ActionEnum.Edit.ToString())
            {
                ...
                if (!new BLL.village().Exists(this.id))
                {
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                if (bll.Add(model) > 0)
                {
                    AddAdminLog(DTEnums.ActionEnum.Add.ToString(), "添加层级分类:" + model.name); //记录日志
                    return true;
                }
            }
            catch
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改类别成功！", "village_list.aspx");
            }
            else //添加
            {
                if (!DoAdd())
                ...
                JscriptMsg("添加类别成功！", "village_list.aspx");
            }
        }
    }
}