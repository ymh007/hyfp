<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subject_list.aspx.cs" Inherits="DTcms.Web.admin.subject.subject_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="subject_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td>
        ...
        <a href="subject_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("name")%></a>
      </td>
      ...
      <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        <a href="subject_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
        <a href="subject_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
