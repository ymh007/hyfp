                ...
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            ...
                            <li><asp:LinkButton ID="btnReject" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnAudit','您确认要驳回该退会申请吗？');" onclick="btnReject_Click"><i></i><span>驳回退会</span></asp:LinkButton></li>
                        </ul>
                    </div>
                    <div class="r-list">
                ...
                <ItemTemplate>
                    <tr>
                       <td align="center">
                        ...
                        <td align="center"><a href="exit_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                        </td>
                         <td align="center">
                            <a href="member_shenqing.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>" >退会申请表</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
