<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="daikuan_chanye_edit.aspx.cs" Inherits="DTcms.Web.admin.daikuan.daikuan_chanye_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="daikuan_chanye_list.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="daikuan_chanye_list.aspx"><span>产业规模</span></a>
            <i class="arrow"></i>
            <span>编辑产业规模</span>
        </div>
