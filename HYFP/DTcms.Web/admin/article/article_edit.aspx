    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>内容标题</dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" " />
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
            ...
            <dl>
                <dt>创建人</dt>
                <dd>
                    <asp:TextBox ID="txtCreatName" runat="server" CssClass="input normal" ReadOnly="true"/>
                </dd>
            </dl>
