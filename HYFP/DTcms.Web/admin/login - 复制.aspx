...
<div class="login-wrap">
  <div class="login-logo">汉阴县扶贫互助资金管理系统</div>
  <div class="login-form">
    <div class="col">
      <asp:TextBox ID="txtUserName" runat="server" CssClass="login-input" placeholder="账号" title="账号"></asp:TextBox>
...
<div class="copy-right">
  <p>版权所有 西安西电科大易达网络科技有限公司 Copyright © 2008 - 2016 dtsoft.net Inc. All Rights Reserved.</p>
</div>
</form>
</body>
</html>
