<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_manager_list.aspx.cs" Inherits="DTcms.Web.admin.account.account_manager_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="account_manager_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td>
        ...
        <a href="account_manager_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("name")%></a>
      </td>
      ...
      <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        <a href="account_manager_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
        <a href="account_manager_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
      </td>
       <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        <a href="subject_list.aspx?action=<%#DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">科目明细</a>
        <a href="account_list.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">账目明细</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
