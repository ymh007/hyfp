<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_manager_edit.aspx.cs" Inherits="DTcms.Web.admin.account.account_manager_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="account_manager_list.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="account_manager_list.aspx"><span>内容类别</span></a>
            <i class="arrow"></i>
            <span>编辑科目</span>
        </div>
