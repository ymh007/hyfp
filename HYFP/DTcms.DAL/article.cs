...
namespace DTcms.DAL
{
    ...
    public partial class article
    {
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,sign_user_name,sign_time)");
                        ...
                        SqlParameter[] parameters = {
					            ...
					            new SqlParameter("@sign_user_name", SqlDbType.NVarChar),
                                new SqlParameter("@sign_time", SqlDbType.NVarChar,500)};
                        ...
                        parameters[23].Value = model.sign_user_name;
                        parameters[24].Value = model.sign_time;
                        //添加主表数据
                        ...
                        if (model.albums != null)
                        {
                            ...
                            foreach (Model.article_albums modelt in model.albums)
                            {
                                ...
                                strSql3.Append("article_id,thumb_path,original_path,remark,link_url)");
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("sign_user_name=@sign_user_name,");
        ...
        {
            //取得相册MODEL
            List<Model.article_albums> albumsList = new DAL.article_albums(databaseprefix).GetList(id, 0);
            //取得附件MODEL
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,sign_user_name,sign_time");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,sign_user_name,sign_time ");
            strSql.Append(" FROM " + databaseprefix + "article ");
            if (strWhere.Trim() != "")
            {
        ...
        private Model.article DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["sign_user_name"] != null)
                {
                    model.sign_user_name = row["sign_user_name"].ToString();
                }
                if (row["sign_time"] != null)
                {
                    model.sign_time = row["sign_time"].ToString();
                }
                #endregion
                ...
                //相册信息
                model.albums = new article_albums(databaseprefix).GetList(model.id, 0);
                //附件信息
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,channel_id,call_index,title,zhaiyao,add_time,img_url,user_name from " + databaseprefix + "article");
