...
namespace DTcms.DAL
{
    ...
    public partial class village
    {
        ...
        public village(string _databaseprefix)
        {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from village");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.village model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into village(");
            strSql.Append("parent_id,name,sort_id)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.village model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update village set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from village");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.village GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 *");
            strSql.Append(" from village ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.village GetModel(string name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 *");
            strSql.Append(" from village ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from village");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update village set " + strValue);
            strSql.Append(" where id=" + id);
            int rows = DbHelperSQL.ExecuteSql(strSql.ToString());
            if (rows > 0)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update village set name=@new_name");
        ...
        /// 得到一个对象实体，带事务
        /// </summary>
        public Model.village GetModel(SqlConnection conn, SqlTransaction trans, string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 *");
            strSql.Append(" from village ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 name from village");
            strSql.Append(" where id=" + id);
        ...
        /// 组合成对象实体
        /// </summary>
        private Model.village DataRowToModel(DataRow row)
        {
            Model.village model = new Model.village();
            if (row != null)
            {
