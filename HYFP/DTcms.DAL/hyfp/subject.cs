...
namespace DTcms.DAL
{
    ...
    public partial class subject
    {
        ...
        public subject(string _databaseprefix)
        {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from subject");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update subject set " + strValue);
            strSql.Append(" where id=" + id);
            int rows = DbHelperSQL.ExecuteSql(strSql.ToString());
            if (rows > 0)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update subject set name=@new_name");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 name from subject");
            strSql.Append(" where id=" + id);
