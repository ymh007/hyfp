...
namespace DTcms.DAL
{
    ...
    public partial class manager
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 real_name from " + databaseprefix + "manager");
            strSql.Append(" where user_name=@user_name");
            SqlParameter[] parameters = {
                    new SqlParameter("@user_name", SqlDbType.NVarChar,100)};
            parameters[0].Value = user_name;
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,categorys)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@categorys", SqlDbType.NVarChar,200)};
            ...
            parameters[10].Value = model.categorys;
        ...
        public bool Update(Model.manager model)
        {
            ...
            strSql.Append("categorys=@categorys");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4),
					new SqlParameter("@role_id", SqlDbType.Int,4),
        ...
        public bool Delete(int id)
        {
            ...
            strSql.Append(" where id=@id and user_name!='admin'");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,categorys from " + databaseprefix + "manager ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                model.categorys = ds.Tables[0].Rows[0]["categorys"].ToString();
                return model;
            }
            else
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,categorys ");
