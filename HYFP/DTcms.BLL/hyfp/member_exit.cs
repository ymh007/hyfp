...
namespace DTcms.BLL
{
    ...
    {
        private readonly DAL.member_exit dal = new DAL.member_exit();
        public member_exit()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.member_exit> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.member_exit> DataTableToList(DataTable dt)
        {
            List<Model.member_exit> modelList = new List<Model.member_exit>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.member_exit model;
