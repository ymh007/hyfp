...
namespace DTcms.BLL
{
    ...
    public partial class article
    {
        ...
        private readonly DAL.article_albums albumsDal;
        ...
        /// 根据频道Id获取相册列表
        /// </summary>
        public List<Model.article_albums> GetAlbumsList(int article_id, int top)
        {
            return albumsDal.GetList(article_id, top);
        }
        #endregion
