...
namespace DTcms.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        public bool IsAdminLogin()
        {
            ...
            else
            {
                ...
                if (adminname != "" && adminpwd != "")
                {
                    ...
                    Model.xiehui model = bll.GetModel(adminname, adminpwd);
                    if (model != null)
                    {
        ...
        /// 取得管理员信息
        /// </summary>
        public Model.xiehui GetAdminInfo()
        {
            if (IsAdminLogin())
            {
                Model.xiehui model = Session[DTKeys.SESSION_ADMIN_INFO] as Model.xiehui;
                if (model != null)
                {
                    return model;
                }
