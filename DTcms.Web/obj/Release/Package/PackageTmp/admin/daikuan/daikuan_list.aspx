<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="daikuan_list.aspx.cs" Inherits="DTcms.Web.admin.manager.daikuan_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="daikuan_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>借款申请</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      <th width="8%">选择</th>
      <th align="left" width="8%">借款人姓名</th>
  ...
  <ItemTemplate>
    <tr>
      <td align="center">
        ...
        <td><%# Eval("reason") %></td>
      <td align="center"><a href="daikuan_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
