<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="warn_list.aspx.cs" Inherits="DTcms.Web.admin.statis.warn_list" %>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      ...
      <th align="left" width="5%" style="color:#ff0000">剩余还款时间</th>
  ...
  <ItemTemplate>
    <tr>
        ...
        <td style="color:#ff0000"><%# Eval("day") %></td>
