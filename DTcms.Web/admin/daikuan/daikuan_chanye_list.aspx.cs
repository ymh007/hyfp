...
{
    public partial class daikuan_chanye_list : Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("daikuan_chanye_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("daikuan_chanye_list.aspx", "keywords={0}", this.keywords));
        }
