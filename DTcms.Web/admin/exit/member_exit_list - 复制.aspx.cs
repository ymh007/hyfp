...
namespace DTcms.Web.admin.exit
{
    public partial class member_exit_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("exit", DTEnums.ActionEnum.View.ToString()); //检查权限
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            this.rptList.DataSource = bll.GetMemberList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
            this.rptList.DataBind();

            //绑定页码
            txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = Utils.CombUrlTxt("member_exit_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("member_exit_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("member_exit_list.aspx", "keywords={0}", this.keywords));
        }
