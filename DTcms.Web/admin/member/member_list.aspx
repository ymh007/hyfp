<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_list.aspx.cs" Inherits="DTcms.Web.admin.member.member_list" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><a href="member_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                         ...
                         <td align="center">
                            <a href="member_shenqing.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>" >入会申请表</a>
                        </td>
                         <td align="center">
                            <a href="member_pingzheng.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>" >缴纳基准互助金凭证</a>
                        </td>
                         <td align="center">
                            <a href="member_shenfenzheng.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">身份证扫描件</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
