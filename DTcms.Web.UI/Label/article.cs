...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected DataTable get_channel_list(int top, string strwhere)
        {
            ...
            dt = new BLL.channel().GetList(top, strwhere, "sort_id asc").Tables[0];
            return dt;
        }
        ...
        /// <returns></returns>
        protected List<Model.article_albums> get_article_albums_list(int article_id, int top)
        {
            return new BLL.article().GetAlbumsList(article_id, top);
        }
        #endregion
        ...
        /// <returns></returns>
        protected int get_article_id(int category_id)
        {
            var ds = new BLL.article().GetList(1, "category_id=" + category_id, "add_time desc");
            if (ds != null)
            {
        ...
        /// <returns></returns>
        protected Model.article get_article_model(int article_id)
        {
            return new BLL.article().GetModel(article_id);
        }
        #endregion
